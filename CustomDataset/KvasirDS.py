...
def my_resize(path, size=256, mask=False):
...
class KvasirDS(tf.keras.utils.Sequence):
    def __init__(self, image_dir, mask_dir, batch_size, shuffle=True, normalize=True, augment=False):
        ...
        self.mask_files = [self.mask_dir / f"{file.stem}.jpg" for file in self.image_files]
