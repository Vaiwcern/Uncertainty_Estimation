...
if __name__ == "__main__":
    ...
    mdir = f"{BASE_ROOT}/model_DRIVE_ensemble/"
    ...
    for i in range(NUM_MODELS):
        ...
        train_image_dir = f"{BASE_DS}/training/images"
        train_mask_dir = f"{BASE_DS}/training/1st_manual"
        train_dataset = DRIVEDataset(image_dir=train_image_dir, mask_dir=train_mask_dir, batch_size=trainparam.batch_size, augment=True)
        test_image_dir = f"{BASE_DS}/test/images"
        test_mask_dir = f"{BASE_DS}/test/1st_manual"
        ...
        model_i = unet(input_shape=(608, 576, 3), dropout_rate=0.0)
