...
if __name__ == "__main__":
    ...
    trainparam = SimpleNamespace(
        ...
        save_path="/home/ltnghia02/MEDICAL_ITERATIVE/model/BUI_iter_dropout"
    )
    ...
    # PREDICT
    # log_file_path = os.path.join(trainparam.save_path, "log_predict_2.txt")
    # os.makedirs(trainparam.save_path, exist_ok=True)  # Đảm bảo thư mục tồn tại
    #
    # sys.stdout = open(log_file_path, "w")
    # sys.stderr = sys.stdout
    ...
    #     model = convert_to_functional(model, input_shape=(256, 256, 4))
    #
    # predict_and_save(model, dataset=test_dataset, image_files=image_files, save_dir=os.path.join(trainparam.save_path, "predict_epoch_100_ver4"))

    # PREDICT massachusetts
    # log_file_path = os.path.join(trainparam.save_path, "log_predict_mass_ver2.txt")
    # os.makedirs(trainparam.save_path, exist_ok=True)  # Đảm bảo thư mục tồn tại
    #
    # sys.stdout = open(log_file_path, "w")
    # sys.stderr = sys.stdout
    ...
    #                  save_dir=os.path.join(trainparam.save_path, "predict_epoch_55_mass_ver2"))
