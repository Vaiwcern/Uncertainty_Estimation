...
if __name__ == "__main__":
    ...
    trainparam = SimpleNamespace(
        ...
        save_path="/home/ltnghia02/MEDICAL_ITERATIVE/model/BUI_iter"
    )
    ...
    #
    #     dummy_x = tf.random.normal((1, 256, 256, 4))
    #     _ = model(dummy_x)
    #
    # model.fit(
    #     train_dataset,
    ...
    predict_and_save(model, dataset=test_dataset, image_files=image_files,
                     save_dir=os.path.join(trainparam.save_path, "predict_epoch_100"))
