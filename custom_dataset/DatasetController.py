...
class DatasetController:
    ...
    def get_roadtracer_train_wrapper(dataset_path, batch_size, add_channel, buffer_size=None):
        print(f"📂 Loading RoadTracer dataset from {dataset_path}")
    ...
    def get_massachusetts_train_wrapper(dataset_path, batch_size, add_channel): 
        print(f"📂 Loading Massachusetts dataset from {dataset_path}")
        print(f"📦 Batch size: {batch_size}, Add channel: {add_channel}")
    ...
    @staticmethod
    def get_massachusetts_test_wrapper(dataset_path, batch_size, add_channel, buffer_size=None): 
        print(f"📂 Loading Massachusetts dataset from {dataset_path}")
        print(f"📦 Batch size: {batch_size}, Add channel: {add_channel}")
